...
<div class="jumbotron text-center main_top">
	<div class="header">
		<img src="/image/White Logo.png" class="img-rounded" alt="Bellas"/>
	</div>
	<br/>
...
<div class="container why_bella bgcolor_gray">
 ...
 <div class="container text-center">
  <div class="row">
    <div class="col-sm-4">
      <img src="/image/why_bella_1.png" class="img-rounded" alt="pet" width="104" height="106">
      <h3>신선하고 정직한 재료</h3>
      <p>사용한 재료를 직접 눈으로 확인해 보세요</p>
    </div>
    <div class="col-sm-4">
      <img src="/image/why_bella_2.png" class="img-rounded" alt="pet" width="94" height="106">
      <h3>반려견 맞춤형 레시피</h3>
      <p>반려견의 몸무게와 식성을 고려하여 조리합니다.</p>
    </div>
    <div class="col-sm-4">
      <img src="/image/why_bella_3.png" class="img-rounded" alt="pet" width="114" height="106">
      <h3>주방에서 직접 조리</h3>
...
<div class="container bella_phelosophy">
 ...
 <h1>우리의 반려견도 건강한 음식을 먹는 행복을 누릴 권리가 있습니다.</h1>
   ...
   <div class="col-sm-5 text-center" style="padding-top: 4%;">
   	<img src="/image/main_food.jpg" class="img-rounded" alt="pet" width="304" height="256">
   </div>
   <div class="col-sm-1">
   </div>
 </div>
